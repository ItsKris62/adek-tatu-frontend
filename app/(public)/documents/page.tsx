...
export const metadata: Metadata = {
  ...
  description:
    'The ADEK document library — party constitution & rules, party manifesto, core values and membership form. Availability reflects each document\u2019s current status.',
}
